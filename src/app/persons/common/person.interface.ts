...
export const PERSONS_IDS: Record<PersonField, string> = {
  ...
  [PersonField.FirstName]: 'PersonFirstName',
  [PersonField.LastName]: 'PersonLastName',
  [PersonField.MiddleName]: 'PersonMiddleName',
...
export interface ChangedPersonBuildings {
  id: number;
  buildings: number[];
}
